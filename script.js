...
function drawMoon(){
    ...
    const moonX = bgCanvas.width - 180;
    const moonY = 130;
    const moonRadius = 60;
    // Moon Glow
...
class Balloon{
    ...
    reset(){
        ...
        this.y = bgCanvas.height + Math.random()*300;
...
class Firework{
    ...
    reset(){
        ...
        this.x = 150 + Math.random()*(bgCanvas.width-300);
...
class ShootingStar {
    ...
    update() {
        ...
        if (
            this.x > bgCanvas.width + 200 ||
            this.y > bgCanvas.height + 200
        ) {
            this.reset();
        }
